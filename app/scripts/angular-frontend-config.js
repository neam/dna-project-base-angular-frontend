...
angular
    ...
    .run(function ($rootScope, $state, $location, AuthService) {
        ...
        var updateTrackersAtSignup = function (profile) {
            ...
            //console.log('user.signup', event, profile);
         ...
         */
        var updateTrackersAtLogin = function (profile) {
        ...
        $rootScope.$on('user.login', function (event, profile) {
            ...
            console.log('user.login profile', event, profile);
            ...
            if (!stored || stored === '') {
                ...
                mixpanel.track('$create_alias', {'alias': profile.user_id}, function () {
