...
let module = require('angular').module('angular-frontend', [
    require('./inspinia/module'),                     // Inspinia-theme-related functionality
    require('./auth'),                         // Authentication logic summarized in auth.js (can not easily be lazyloaded since it integrates tightly with ui-router config + authentication needs to be evaluated asap upon page load to catch recurring already authenticated users)
